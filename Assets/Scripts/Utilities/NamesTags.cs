...
public class NamesTags
{
    ...
    public static string ProjectilesParentName => "Power_Ups_Container";
    public static string PowerUpsParentName => "Projectiles_Container";
    public static string TouchPadName => "Touchpad";
