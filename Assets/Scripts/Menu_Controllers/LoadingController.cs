...
public class LoadingController : MonoBehaviour
{
    ...
    private void TranslateLabels ()
    {
        ...
        foreach (string label in LocalizationController.Instance.GetInstructions01Labels ()) { labels.Add (label); }
        foreach (string label in LocalizationController.Instance.GetInstructions02Labels ()) { labels.Add (label); }
        foreach (string label in LocalizationController.Instance.GetInstructions03Labels ()) { labels.Add (label); }
