...
public class Block : MonoBehaviour
{
    ...
    public int GetStartMaxHits () { return this.startMaxHits; }

    public void SetCanSpawnPowerUp (bool canSpawnPowerUpBlock) { this.canSpawnPowerUp = canSpawnPowerUpBlock; }
    public void SetMaxHits (int maxHits) { this.maxHits = maxHits; }
    public void SetStartMaxHits (int startMaxHits) { this.startMaxHits = startMaxHits; }
    ...
    private void DestroyBlock ()
    {
        ...
        if (collidedWithBall) { GameSession.Instance.AddToComboMultiplier (); }
        ...
        // Spawn powerups
        if (canSpawnPowerUp) { SpawnPowerUp (); }
