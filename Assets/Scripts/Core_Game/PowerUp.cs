...
public class PowerUp : MonoBehaviour
{
    ...
    private void ApplyPowerUpEffect (string powerUpName)
    {
        switch (powerUpName)
        {
            ...
            case "PowerUp_FireBall": { DefineFireBalls (); currentPowerUpIndex = 6; break; }
            case "PowerUp_Move_Blocks_Right": { DefineMoveBlocks ("Right"); currentPowerUpIndex = 7; break; }
            case "PowerUp_Move_Blocks_Left": { DefineMoveBlocks ("Left"); currentPowerUpIndex = 8; break; }
            case "PowerUp_Move_Blocks_Up": { DefineMoveBlocks ("Up"); currentPowerUpIndex = 9; break; }
            case "PowerUp_Move_Blocks_Down": { DefineMoveBlocks ("Down"); currentPowerUpIndex = 10; break; }
            case "PowerUp_Paddle_Expand": { if (paddle) { paddle.DefinePaddleSize (true); currentPowerUpIndex = 11; } break; }
            case "PowerUp_Paddle_Shrink": { if (paddle) { paddle.DefinePaddleSize (false); currentPowerUpIndex = 12; } break; }
            case "PowerUp_Reset_Ball": { ResetBalls (); currentPowerUpIndex = 13; break; }
            case "PowerUp_Reset_Paddle": { if (paddle) { paddle.ResetPaddle (); currentPowerUpIndex = 14; } break; }
            case "PowerUp_Shooter": { CreateShooter (); currentPowerUpIndex = 15; break; }
            case "PowerUp_Unbreakables_To_Breakables": { MakeUnbreakableToBreakable (); currentPowerUpIndex = 16; break; }
            default: { break; }
        }
    }
    ...
    private void MakeAllBlocksOneHit ()
    {
        ...
        if (blocks.Length != 0)
        {
            foreach (Block block in blocks) { block.SetMaxHits (1); block.SetStartMaxHits (1); }
        }
    }
