...
public class PauseController : MonoBehaviour
{
    ...
    private void TranslateLabels ()
    {
        ...
        foreach (string label in LocalizationController.Instance.GetPauseLabels ()) { labels.Add (label); }
    ...
    private void BindButtonClickEvents ()
    {
        ...
        allPauseMenuButtons[2].onClick.AddListener (() => StartCoroutine (ResetGameCoroutine (SceneManagerController.GetSelectLevelsSceneName ())));
    }
